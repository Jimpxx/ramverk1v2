 ...
 */
class IpMapControllerTest extends TestCase
{
    ...
    public function testIndexAction()
    {
        ...
        $controller = new IpMapController();
    ...
    public function testIndexActionPost()
    {
        ...
        $this->di->get("request")->setPost("doGeo", "Get info");

        // Test the controller action
        $res = $controller->indexActionPost();
        $body = $res->getBody();
        $this->assertStringContainsString("Geo Results", $body);
    }
}
